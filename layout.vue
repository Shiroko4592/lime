    ...
    <div class="Liberty" :style="skinConfig">
        ...
        <div class="nav-wrapper" :class="{ 'navbar-fixed-top': $store.state.localConfig['liberty.fixed_navbar'] === true }">
            <nav class="navbar navbar-dark">
                <nuxt-link class="navbar-brand" to="/"><img v-if="$store.state.config['wiki.logo_url']" :src="$store.state.config['wiki.logo_url']" style="height: 1.9rem; margin-right: 0.65rem; vertical-align: middle;" /><span class="navbar-brand-text">{{ $store.state.config['skin.liberty.navbar_logo_text'] }}</span></nuxt-link>
                ...
                <div id="bottom" class="liberty-footer">
                    ...
                    <ul class="footer-icons">
                        <li class="footer-poweredbyico">
                            <a href="//github.com/lidarbtc/thetree-skin-liberty" target="_blank">Liberty</a> | <a href="//github.com/wjdgustn/thetree" target="_blank">the tree</a>
                        </li>
                    </ul>
                </div>
